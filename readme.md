# HDI_4DVP_FreezePanes

How do I freeze columns and rows in [4D View Pro](https://us.4d.com/4d-view-pro)? (4D v18 R2)

Find more information on the [blog post](https://blog.4d.com/4d-view-pro-freeze-panes-to-lock-rows-or-columns/).
